//
// Generated file, do not edit! Created by nedtool 5.5 from message.msg.
//
...
int Message::getSource_id() const
{
    return this->source_id;
}

void Message::setSource_id(int source_id)
{
    this->source_id = source_id;
}

int Message::getDestination_id() const
{
    return this->destination_id;
}

void Message::setDestination_id(int destination_id)
{
    this->destination_id = destination_id;
}

double Message::getGeneration_time() const
{
    return this->generation_time;
}

void Message::setGeneration_time(double generation_time)
{
